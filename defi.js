...
var showCoin = async(id, icon) => {
                  let data = await CoinGeckoClient.coins.fetch(id, { 'localization':  false, 'developer_data': false, 'tickers': false, 'sparkline': false});
...
var showCoinHistory = async(id, the_date, the_date2) => {
                  let data = await CoinGeckoClient.coins.fetchHistory(id, { 'date':  the_date});
                //      console.log(data.data);
                        coin = data.data;
                        name = coin.name;
...
var showCoinDev = async(id, icon) => {
                  let data = await CoinGeckoClient.coins.fetch(id, { 'localization':  false, 'developer_data': true, 'tickers': false, 'market_data': false, 'sparkline': false});
                //      console.log(data.data);
...
var showCoinLinks = async(id, icon) => {
                  let data = await CoinGeckoClient.coins.fetch(id, { 'localization':  false, 'developer_data': false, 'tickers': false, 'market_data': false, 'sparkline': false});
                //      console.log(data.data);
